...
import objects.ManaPotion;

import java.awt.*;
import java.awt.image.BufferedImage;

public class ManaPotionEntity extends Entity{

    public ManaPotionEntity(GamePanel gp, int x, int y){
        ...
        up1 = loadImage("/object/usable/mana_potion.png");
        maxHP = 1;
        curHP = 1;
    }
    ...
    public ManaPotion createPotion() {

        return new ManaPotion(gp);
